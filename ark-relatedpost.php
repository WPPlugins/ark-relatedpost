...
<table>
<tr valign="top">
<td>Ширина миниатюры <input type="number" min="0" max="400" name="ark_imgsize" size="3" value="<?php echo $result['ark_imgsize']; ?>" /><b>px</b>&nbsp;</td>
	...
	if( $my_query->have_posts() ) {
        ...
        while ($my_query->have_posts()) {
			...
			// Настройки вертикального вывода
				...
				// Определяем картинку
				$arkpimg = '<img class="nohover" width="' . $result['ark_imgsize'] . 'px" height="auto" align="'.$arkimgalign.'" style="'.$arkimgborderradius.' max-width:'.$result['ark_imgsize'].'px;" src="' . ark_that_image($userimgurl) . '" />';					
			} else {
				...
				$arkimgalign = 'top';
				// Определяем картинку
				$arkpimg = '<img class="nohover" width="100%" height="auto" align="'.$arkimgalign.'" style="'.$arkimgborderradius.' max-width:100%" src="' . ark_that_image($userimgurl) . '" />';	
			}
